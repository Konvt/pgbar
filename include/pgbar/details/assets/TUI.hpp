...
#define PGBAR__DEFAULT_PERCENT u8" --.--%"
      ...
      protected:
        ...
        PGBAR__NODISCARD PGBAR__INLINE_FN PGBAR__CNSTEVAL types::Size fixed_len_percent() const noexcept
        {
...
#define PGBAR__ELASPED u8"--:--:--"
        ...
        PGBAR__NODISCARD PGBAR__INLINE_FN PGBAR__CNSTEVAL types::Size fixed_len_elapsed() const noexcept
        {
...
#define PGBAR__COUNTDOWN u8"~" PGBAR__ELASPED
        ...
        PGBAR__NODISCARD PGBAR__INLINE_FN PGBAR__CNSTEVAL types::Size fixed_len_countdown() const noexcept
        {
