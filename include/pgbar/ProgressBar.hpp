...
namespace pgbar {
  namespace _details {
    namespace assets {
      ...
      public:
        PGBAR__EMPTY_COMPONENT( CharIndic )
      };
    } // namespace assets

    namespace traits {
      PGBAR__INHERIT_REGISTER( assets::CharIndic,
                               assets::Filler,
                               assets::Remains,
  ...
  namespace config {
    class Line : public _details::prefabs::BasicConfig<_details::assets::CharIndic, Line> {
      using Base = _details::prefabs::BasicConfig<_details::assets::CharIndic, Line>;
      friend Base;
  ...
  namespace _details {
    namespace traits {
      PGBAR__BIND_BEHAVIOUR( config::Line, assets::BoundedFrameBar );
    }
